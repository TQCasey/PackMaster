 ...
 */
public class MySignalStrength implements Parcelable {
     ...
     * @hide
     */
    public static MySignalStrength newFromBundle(Bundle m) {
    	MySignalStrength ret;
        ret = new MySignalStrength ();
     ...
     * @hide
     */
    public MySignalStrength (boolean gsmFlag) {
        mGsmSignalStrength = 99;
        mGsmBitErrorRate = -1;
        mCdmaDbm = -1;
        mCdmaEcio = -1;
     ...
     * @hide
     */
    public MySignalStrength (int gsmSignalStrength, int gsmBitErrorRate,
     ...
     * @hide
     */
    public MySignalStrength (MySignalStrength s) {
        copyFrom(s);
    }
     ...
     * @hide
     */
    protected void copyFrom(MySignalStrength  s) {
     ...
     * @hide
     */
    public MySignalStrength (Parcel in) {
     ...
     * @hide
     */
    public static final Parcelable.Creator<MySignalStrength> CREATOR = new Parcelable.Creator() {
        public MySignalStrength createFromParcel(Parcel in) {
            return new MySignalStrength (in);
        }

        public MySignalStrength[] newArray(int size) {
            return new MySignalStrength [size];
        }
    };
    ...
    public void validateInput() {
        ...
        mLteRsrp = ((mLteRsrp >= 44) && (mLteRsrp <= 140)) ? -mLteRsrp : MySignalStrength.INVALID;
        mLteRsrq = ((mLteRsrq >= 3) && (mLteRsrq <= 20)) ? -mLteRsrq : MySignalStrength.INVALID;
        mLteRssnr = ((mLteRssnr >= -200) && (mLteRssnr <= 300)) ? mLteRssnr
                : MySignalStrength.INVALID;
        // Cqi no change
    ...
    public int getLteAsuLevel() {
         ...
         * and not 97 or 0
         */
        if (lteDbm == MySignalStrength.INVALID) lteAsuLevel = 255;
