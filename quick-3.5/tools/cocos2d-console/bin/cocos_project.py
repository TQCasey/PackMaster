...
class Platforms(object):
    ...
    def project_path(self, isAs = False):
...
class AndroidConfig(PlatformConfig):
    ...
    def _use_default(self):
        if self._is_script:
            ...
            self.studio_path = os.path.join(self._proj_root_path, "frameworks", "runtime-src", "proj.studio")
        else:
            self.proj_path = os.path.join(self._proj_root_path, "proj.android")
            self.studio_path = os.path.join(self._proj_root_path, "proj.studio")
