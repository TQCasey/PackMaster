...
class CCPluginLuaCompile(cocos.CCPlugin):
    ...
    def init(self, options, workingdir):
        ...
        self._use_v2103 = options.use_v2103
        self._use_arm64 = options.use_arm64
    ...
    def get_luajit_path(self):
        ...
        if cocos.os_is_win32():
            if self._use_v2103 == True:
                print ('====> use LuaJIT v2.1.0 beta3')
                if self._use_arm64 == True:
                    print ('====> make it be 64bit ..')
                    ret = os.path.join(self._workingdir, "bin2103", "64","luajit.exe")
                else:
                    print ('====> make it be 32bit ..')
                    ret = os.path.join(self._workingdir, "bin2103", "32","luajit.exe")
            else:
                print ('====> use LuaJIT v2.0.3 .')
                ret = os.path.join(self._workingdir, "bin2030","luajit.exe")
            ...
            if self._use_v2103 == True:
                ...
                if self._use_arm64 == True:
                    print ('====> make it be 64bit ..')
                    ret = os.path.join(self._workingdir, "bin2103", "64", "lua", "luajit-mac")
                else:
                    print ('====> make it be 32bit ..')
                    ret = os.path.join(self._workingdir, "bin2103", "32", "lua", "luajit-mac")
            else:
                print ('====> use LuaJIT v2.0.3 .')
                ret = os.path.join(self._workingdir, "bin2030", "lua", "luajit-mac")

        elif cocos.os_is_linux():
            ret = os.path.join(self._workingdir, "bin2030", "lua", "luajit-linux")
    ...
    def parse_args(self, argv):
        ...
        parser.add_argument("--use-v2103",
                          action="store_true", dest="use_v2103", default=False,
                          help='use LuaJIT v2.1.0 beta3')
        parser.add_argument("--use-arm64",
                          action="store_true", dest="use_arm64", default=False,
                          help='use arm64 tool')
